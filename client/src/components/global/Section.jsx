      ...
      <div className="mt-20 px-32 ">
        <div className="  flex justify-between w-full">
          <div className="w-2/5 flex flex-col space-y-6 ">
            <h3 className="  text-4xl font-lato ">
              Secure & Reliable Banking with us
            </h3>
            <p className="font-main text-[#ffffff90] ">
              We prioritize your financial security with advanced encryption,
              AI-driven fraud detection, and trusted banking solutions.
            </p>
            <div>
            ...
            <div className="flex mt-6">
              <button className="bg-green font-semibold   text-dark px-4 py-2 rounded-full font-main ">
                Get Started
              </button>
            </div>
          </div>
